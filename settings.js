...
window.addEventListener('load', () => {
    ...
    settingsIcon.addEventListener('click', async () => {
        await loadSettings();
        themeBeforeOpen = readStoredTheme();
    ...
    cancelSettingsBtn.addEventListener('click', async () => {
        ...
        await applyThemeSafe(themeBeforeOpen);
        if (themeSelector) themeSelector.value = themeBeforeOpen;
    });
            ...
            document.body.insertAdjacentHTML('beforeend', `
                    ...
                    <div class="settingsModal" id="settingsModal">
                        <div class="settingsContent">
                            ...
                            <h3 id="themeTitle" class="langText">Theme</h3>
                            <select id="themeSelector">
                                <option value="light" id="themeOptionLight" class="langText">Light</option>
                                <option value="dark" id="themeOptionDark" class="langText">Dark</option>
                            </select>
                            ...
                            <div class="settingsFormGroup">
                                <label for="metaCompany" id="companyLabel" class="langText">Company:</label>
                                <input type="text" id="metaCompany" class="langTextPlaceholder" placeholder="Enter company name">
                            </div>
                            ...
                            <div class="settingsAbout">
                                <button type="button" class="settingsAboutLink langText" id="aboutOpenFromSettings">About Pdeffy</button>
                            </div>
