// The IIFE is used so that the ipcRenderer constant does not have a global scope
// and does not conflict with other ipcRenderers from other JS files like merge.js, split.js, etc.
(() => {
